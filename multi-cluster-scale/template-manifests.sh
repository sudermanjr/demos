...
helm template cert-manager -n cert-manager jetstack/cert-manager --version 1.13.2 --values cert-manager.values.yaml | kubectl slice -f - -o ./manifests/cert-manager/
